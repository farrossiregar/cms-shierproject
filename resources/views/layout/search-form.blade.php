        ...
        <div class="row">
            <div class="col s12 l4">
                ...
                <div class="each-result">
                    <img src="{{ asset('assets/_con/images/user2.jpg') }}" alt="Felecia Castro" class="circle photo">
                    <div class="title">Felecia Castro</div>
                    <div class="label">Content Manager</div>
                </div>

                <div class="each-result">
                    <img src="{{ asset('assets/_con/images/user3.jpg') }}" alt="Max Brooks" class="circle photo">
                    <div class="title">Max Brooks</div>
                    <div class="label">Programmer</div>
                </div>

                <div class="each-result">
                    <img src="{{ asset('assets/_con/images/user4.jpg') }}" alt="Patsy Griffin" class="circle photo">
                    <div class="title">Patsy Griffin</div>
                    <div class="label">Support</div>
                </div>

                <div class="each-result">
                    <img src="{{ asset('assets/_con/images/user6.jpg') }}" alt="Vernon Garrett" class="circle photo">
