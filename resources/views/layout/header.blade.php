<meta charset="utf-8">
    ...
    <!-- Rickshaw -->
    <link rel="stylesheet" type="text/css" href="{{ asset('bower_components/rickshaw/rickshaw.min.css') }}" />
    ...
    <!-- jvectormap -->
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/jquery-jvectormap/jquery-jvectormap.css') }}" />
